...
function BarisBaru()
{
	...
	Baris += "<td>";
	Baris += "<select name='id_jenis_kiriman[]' class='form-control input-sm' style='width:100px;'>";
	Baris += "<option value=''></option>";

	<?php 
	if($jenis_kiriman->num_rows() > 0)
	{
		foreach($jenis_kiriman->result() as $j) { ?>
			Baris += "<option value='<?php echo $j->id_jenis_kiriman; ?>'><?php echo $j->jenis_kiriman; ?></option>";
		<?php }
	}
	?>
	Baris += "</select>";
	...
	Baris += "<td>";
	Baris += "<select name='id_ekspedisi_awal[]' class='form-control input-sm' style='width:100px;'>";
	Baris += "<option value=''></option>";

	<?php 
	if($ekspedisi_awal->num_rows() > 0)
	{
		foreach($ekspedisi_awal->result() as $e) { ?>
			Baris += "<option value='<?php echo $e->id_ekspedisi_awal; ?>'><?php echo $e->ekspedisi_awal; ?></option>";
		<?php }
	}
	?>
	Baris += "</select>";
